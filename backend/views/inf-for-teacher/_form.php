...
<div class="inf-for-teacher-form">
    ...
    <?= $form->field($model, 'user_id')->dropDownList(\backend\models\UserName::find()->select(["CONCAT(lastname, ' ', firstname)", 'id'])->where(['status' => 1])->indexBy('id')->column(), ['prompt' => 'Выбрать преподавателя...']) ?>
